...
[![release](https://img.shields.io/static/v1?label=release&message=v0.0.4&color=blue)](https://github.com/PlayForm/Auth-Cloudflare/releases)
[![plugin](https://img.shields.io/static/v1?label=plugin&message=v0.0.4&color=purple)](https://github.com/PlayForm/Auth-Hermes-Cloudflare/blob/Current/plugin.yaml)
