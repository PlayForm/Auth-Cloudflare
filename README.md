...
[![release](https://img.shields.io/static/v1?label=release&message=v0.0.3&color=blue)](https://github.com/PlayForm/Auth-Cloudflare/releases)
[![plugin](https://img.shields.io/static/v1?label=plugin&message=v0.0.3&color=purple)](https://github.com/PlayForm/Auth-Hermes-Cloudflare/blob/Current/plugin.yaml)
...
| Fallback catalog | 26 primary-eligible chat models compiled into the profile (regenerated by `scripts/regenerate-fixtures.sh`)                                  |
...
curated catalog compiled into the profile (26 primary-eligible chat models).
...
**`Curated fallback catalog (26 primary-eligible chat models)`**
...
| Catalog fetch fails (API error, missing data array, timeout) | Non-fatal by design - the provider falls back to the curated 26-model catalog and the picker keeps working.                                                                 |
