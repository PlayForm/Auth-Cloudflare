...
# Actions discovered in /Volumes/CORSAIR/Developer/macOS/Application/PlayForm/Auth-Cloudflare at absorb time (informational).
DiscoveredActions=( "softprops/action-gh-release" "actions/checkout" "dtolnay/rust-toolchain" "actions/upload-artifact" "actions/cache" "rust-lang/crates-io-auth-action" )
