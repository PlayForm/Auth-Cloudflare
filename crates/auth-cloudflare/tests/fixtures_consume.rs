...
//! in memory. The three fixtures must exercise the three policy statuses
//! the picker depends on: recommended (DeepSeek V4 Flash), experimental
//! (GLM-5.3 Flash), hidden (Llama Guard 3 8B).
...
fn every_fixture_is_cloudflare_hosted_and_chat_shaped() {
	for fixture in [DEEPSEEK, GLM, LLAMA_GUARD] {
